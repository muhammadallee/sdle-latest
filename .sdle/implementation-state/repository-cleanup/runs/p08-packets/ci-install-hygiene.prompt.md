...
## Your area: CI, install inventory and shipped-surface hygiene
...
Whether the install inventory in docs/GETTING-STARTED.md matches what a target actually needs; developer-local content or machine paths in shipped files; executable bits; CI matrix and pins; directory-layout inconsistencies and empty/placeholder-only directories.
