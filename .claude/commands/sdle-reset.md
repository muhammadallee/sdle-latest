...
2. Warn the user: `state.json`, `audit.md` and `lock` under the active
   ...
   identity itself (`workitems/<id>/workitem.json`, `workitems/index.md`) and
   everything under `.specify/`, `design/`, `reviews/` and `clarifications/`
   survives. This cannot be undone.
